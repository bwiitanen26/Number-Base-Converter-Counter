...
function main() {
	...
	document.getElementById("copyBinaryButton").addEventListener("click", copyBinary);
...
function copyText() {
	navigator.clipboard.writeText(document.getElementById("textField").value);
}

function copyBinary() {
	navigator.clipboard.writeText(document.getElementById("binTextField").value);
}
