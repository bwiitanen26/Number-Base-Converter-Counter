 ...
 */
function main() {
	// Retrieves saved field information from Chrome Local Storage
	getFields();

	//Adds event listeners to field boxes and runs update functions when field boxes are typed in
	...
	//Adds event listeners to copy buttons on side of field boxes and runs functions when buttons are pressed
	...
	//Adds event listeners to bottom buttons and runs functions when buttons are pressed
